    ...
    // uniform sampler2D noiseTex;
        ...
        vec4 getVideo(vec2 uv)
        {
            ...
            if(distortionOn){
                ...
                look.x = look.x + (sin(look.y*10.0 + iTime)/50.0*onOff(4.0,4.0,0.3)*(1.+cos(iTime*80.0))*window)*(glitchModifier*2.0);
        ...
        gl_FragColor = mix(video,vec4(noise(uv * 75.0) * noiseIntensity),0.05);
